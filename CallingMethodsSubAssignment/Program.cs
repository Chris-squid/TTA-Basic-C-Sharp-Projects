...
namespace CallingMethodsSubAssignment
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("The number you entered plus 10 = " + math.mathOperation1(input)); //calls the method and passes the
            Console.WriteLine("The number you entered subtracted by 10 = " + math.mathOperation2(input)); // user input as a parameter
            Console.WriteLine("The number you entered multiplied by 10 = " + math.mathOperation3(input));
            Console.ReadLine();
        }
    }
}
