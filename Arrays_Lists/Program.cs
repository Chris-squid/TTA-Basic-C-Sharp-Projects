...
namespace Arrays_Lists
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] wordArray = { "Luck", "Love", "Death", "Hope", "Change" };
            Console.WriteLine("Enter an index between 0 and 4 to obtain a Reading from the Internet Tarot: ");
            ...
            stringArray.Add("You're Awesome");
            stringArray.Add("Hit the road Jack!");
            stringArray.Add("Keep Trying");
